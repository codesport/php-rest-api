...
1. Updated DocBlock in [`class-statistics.php`](https://github.com/codesport/php-rest-api/blob/php-class-updates/src/class-statistics.php_) with instructions on how to use the class
